...
export function MobileGalleryView() {
  ...
  const cssParticipantCount =
    role !== process.env.REACT_APP_EC_NAME ? remoteParticipantCount : remoteParticipantCount - 1 >= 0 ? remoteParticipantCount - 1 : 0;
  ...
  const portraitParticipantVideoStyles: CSSProperties = {
    width: cssParticipantCount < 3 ? '100%' : '50%',
    ...
    height: ['100%', '50%', '33.33%', '50%', '33.33%'][Math.min(cssParticipantCount, 4)],
    padding: '0.2em',
    boxSizing: 'border-box',
  };

  const landscapeParticipantVideoStyles: CSSProperties = {
    height: cssParticipantCount < 3 ? '100%' : '50%',
    width: ['100%', '50%', '33.33%', '50%', '33.33%'][Math.min(cssParticipantCount, 4)],
    padding: '0.2em 0.1em',
    boxSizing: 'border-box',
  };
