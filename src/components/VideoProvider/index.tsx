...
export interface IVideoContext {
  ...
  isVonageConnecting: boolean;
  vonageSession: Session | null;
  vonageConnect: (apiKey: string, sessionId: string, token: string) => void;
...
export function VideoProvider({ options, children, onError = () => {} }: VideoProviderProps) {
  ...
  const { room, isConnecting, connect, vonageConnect, vonageSession, isVonageConnecting } = useRoom(
    localTracks,
    onErrorCallback,
    options
  );
