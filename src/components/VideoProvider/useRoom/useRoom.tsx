...
export default function useRoom(localTracks: LocalTrack[], onError: Callback, options?: ConnectOptions) {
  ...
  const [vonageSession, setVonageSession] = useState<Session | null>(null);
  ...
  const vonageConnect = (apiKey: string, sessionId: string, token: string) => {
  ...
  return { room, isConnecting, connect, vonageSession, isVonageConnecting, vonageConnect };
}
